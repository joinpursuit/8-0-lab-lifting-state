...
// function captureIndex(event){
//   (event.target).findIndex(event.target)
// }
...
export default App;
// export {addEvent, handleSelectChange,handleSubmit,handleTextChange,resetEventForm,handleAddEvent,toggleEventAttendees,updateEventAttendance}